...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for idx in range(26):
            shift_dict[LOWERCASE[idx]] = LOWERCASE[(idx + shift) % 26]
            shift_dict[UPPERCASE[idx]] = UPPERCASE[(idx + shift) % 26]
        return shift_dict
    ...
    def apply_shift(self, shift):
        ...
        for char in self.message_text:
            if char in LETTERS:
                message_shifted += shift_dict[char]
            else:
    ...
    def decrypt_message(self):
        ...
        for shift in range(26):
            ...
            if score > score_best:
                ...
                score_best = score
        return shift_best, message_decrypted
